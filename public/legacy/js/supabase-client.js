(function (window) {
    ...
    async function createBooking(payload) {
        ...
        var row = {
            ...
            guest_id: user.id,
            property_id: pid,
            property_title: String(payload.propertyTitle || '').trim(),
            property_region: String(payload.propertyRegion || '').trim(),
            property_main_image: String(payload.propertyMainImage || '').trim(),
            check_in: checkIn,
            check_out: checkOut,
