 ...
 * Неавторизованный пользователь не может: бронировать, оставлять отзыв, использовать кнопки футера (Разместить объект и т.д.). Избранное без входа хранится локально в браузере.
 */
(function() {
    function isLoggedIn() {
        try {
