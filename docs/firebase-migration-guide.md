...
Важно для UX чата: ответы помощника должны вести пользователя по страницам Silva и содержать кликабельные ссылки на нужные разделы (например каталог, вход, профиль, бронирования).
